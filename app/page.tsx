      ...
      <div className="container max-w-3xl px-4 py-8">
          ...
          <CardContent className="pt-6">
            <div className="flex flex-col items-center space-y-4">
              ...
              <div className="text-center">
                ...
                <p className="mt-4">
                  Hi! Im David, an Information Systems Engineering student currently in my second year. Im passionate about back-end development, networks, and cloud computing, always eager to understand how apps and technology work behind the scenes. Problem-solving and creativity are part of my everyday grind.
        ...
        <Card>
          <CardHeader className="text-center">
            <CardTitle>Here you will find stuff i write</CardTitle>
